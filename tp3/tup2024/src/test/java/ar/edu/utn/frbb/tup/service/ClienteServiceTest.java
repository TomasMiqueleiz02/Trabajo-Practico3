...
public class ClienteServiceTest {
    ...
    @Test
    public void testAgregarDosCuentasSuccess() throws TipoCuentaAlreadyExistsException {
        Cliente luciano = new Cliente();
        luciano.setDni(26456439);
        luciano.setNombre("Pepe");
        luciano.setApellido("Rino");
    ...
    @Test
    public void testAgregarDosCuentasConDiferenteMonedaSuccess() throws TipoCuentaAlreadyExistsException {
        Cliente luciano = new Cliente();
        luciano.setDni(26456439);
        luciano.setNombre("Pepe");
        luciano.setApellido("Rino");
    ...
    @Test
    public void testBuscarporDniSucces()throws IllegalArgumentException{
        Cliente luciano = new Cliente();
        luciano.setDni(26456439);
        luciano.setNombre("Pepe");
        luciano.setApellido("Rino");
        ...
        clienteService.buscarClientePorDni(26456439);

        verify(clienteDao,times(1)).find(26456439,true);

        assertEquals(26456439,luciano.getDni());

    }
    @Test
    public void testBuscarporDniError()throws IllegalArgumentException{
        Cliente luciano = new Cliente();
        luciano.setDni(26456439);
        luciano.setNombre("Pepe");
        luciano.setApellido("Rino");
